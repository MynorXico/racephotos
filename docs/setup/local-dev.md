...
| Tool           | Version | Notes                                                             |
| -------------- | ------- | ----------------------------------------------------------------- |
| Docker         | 24+     | Required for LocalStack                                           |
...
> **Alternative to `awscli-local`:** export `AWS_ENDPOINT_URL=http://localhost:4566`
> and use the regular `aws` CLI. The seed script detects whichever is available.
